...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const fylkePages: MetadataRoute.Sitemap = FYLKER.map(f => ({
  ...
  const kommunePages: MetadataRoute.Sitemap = KOMMUNER.map(k => ({
