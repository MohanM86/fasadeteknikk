...
export default function HomePage() {
  return (<>
    <Header /><main>
      ...
      <section className="section-dark"><div className="container-site py-8"><div className="grid grid-cols-2 sm:grid-cols-4 gap-6">{[{ v: "357", l: "Kommuner dekket" }, { v: "15", l: "Fylker" }, { v: "24t", l: "Responstid" }, { v: "100%", l: "Gratis" }].map(({ v, l }) => (<div key={l} className="text-center"><div className="font-display font-extrabold text-4xl text-brand-500 tracking-tight">{v}</div><div className="text-xs text-neutral-500 mt-1">{l}</div></div>))}</div></div></section>
