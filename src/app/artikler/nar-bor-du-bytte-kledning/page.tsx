...
export const metadata: Metadata = { title: "Artikkel om fasade | Fasadeteknikk.no", description: "Les vår guide om fasadearbeid.", alternates: { canonical: `https://fasadeteknikk.no/artikler/nar-bor-du-bytte-kledning` } };
