...
export const metadata: Metadata = {
  ...
  description: "Lær hvordan du vedlikeholder husets fasade for å forlenge levetiden.",
...
export default function Artikkel() {
  return (
    <>
      <Header />
      <main>
        <div className="container-site pt-5 pb-2"><Breadcrumb items={[{ navn: "Artikler" }, { navn: "Slik vedlikeholder du fasaden" }]} /></div>
        <section className="hero-pattern">
          <div className="container-site py-10 sm:py-14 max-w-3xl">
            ...
            <h1 className="font-display font-extrabold text-display-xl text-neutral-900 mb-4 text-balance">Slik vedlikeholder du fasaden</h1>
            <p className="text-body-lg text-neutral-500">Regelmessig vedlikehold forlenger levetiden og sparer deg for kostbare reparasjoner.</p>
          </div>
        </section>
        <article className="section-white section-py-sm">
          <div className="container-site max-w-3xl text-body-md text-neutral-600 leading-relaxed space-y-6">
            <p>Regelmessig vedlikehold forlenger levetiden og sparer deg for kostbare reparasjoner. Her er en komplett guide med alt du trenger å vite.</p>
