...
export const metadata: Metadata = {
  ...
  description: "Fasadeteknikk.no er Norges ledende plattform for å finne kvalifiserte fasadefirma.",
      ...
      <main>
        ...
        <section className="section-dark section-py-sm">
          <div className="container-site text-center">
            <h1 className="font-display font-extrabold text-display-xl text-white mb-4 text-balance">Norges ledende plattform for fasade</h1>
            <p className="text-body-lg text-neutral-400 max-w-2xl mx-auto">Fasadeteknikk.no kobler huseiere med kvalifiserte fasadefirma i hele Norge. Enkelt, trygt og gratis.</p>
          </div>
        </section>
        ...
        <section className="section-light section-py-sm">
          <div className="container-site max-w-3xl">
            <h2 className="font-display font-extrabold text-heading-xl text-neutral-900 mb-5">Vår visjon</h2>
            <div className="space-y-4 text-body-md text-neutral-500 leading-relaxed">
              ...
              <p>Vår plattform løser dette ved å samle informasjon, ekspertise og tilgang til kvalifiserte firma på ett sted. Vi er uavhengige og anbefaler ikke spesifikke firma.</p>
        ...
        <section className="section-py-sm">
          <div className="container-site"><div className="cta-block text-center relative z-10">
            <h2 className="font-display font-extrabold text-display-lg text-white mb-4">Klar til å komme i gang?</h2>
            <Link href="/kontakt" className="btn-primary">Bestill gratis tilbud <ArrowRight className="w-5 h-5" /></Link>
          </div></div>
        </section>
      </main>
      <Footer />
