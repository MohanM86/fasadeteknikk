      ...
      <Header /><main>
        ...
        <section className="hero-pattern" aria-labelledby="tjeneste-h"><div className="container-site py-10 sm:py-14"><div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <div className="card-flat p-5 mb-6 inline-block"><div className="text-label text-neutral-400 mb-0.5">Typisk prisintervall</div><div className="font-display font-bold text-heading-lg text-brand-500">{formatPrisIntervall(tjeneste.prisMin, tjeneste.prisMax)}</div><div className="text-caption text-neutral-400">{tjeneste.prisenhet} – veiledende</div></div>
        ...
        <section className="section-py-sm"><div className="container-site"><div className="cta-block text-center relative z-10"><h2 className="font-display font-extrabold text-display-lg text-white mb-3">Bestill {tjeneste.kortTittel.toLowerCase()} – gratis tilbud</h2><p className="text-base text-neutral-500 mb-6">Sammenlign tilbud fra kvalifiserte firma i ditt område.</p><Link href="#tilbud" className="btn-primary">Få gratis tilbud <ArrowRight className="w-4 h-4" /></Link></div></div></section>
