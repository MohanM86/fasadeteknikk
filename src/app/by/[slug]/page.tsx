...
export default function BySide({ params }: Props) {
  ...
  const faqItems = [
    { sporsmal: `Hva koster fasadearbeid i ${by.navn}?`, svar: `Prisene i ${by.navn} følger landsgjennomsnittet. Maling koster 300 til 800 kr per kvm, kledning 1 200 til 3 500 kr per kvm, og full rehabilitering 1 500 til 4 500 kr per kvm.` },
    ...
    { sporsmal: `Trenger jeg byggetillatelse for fasadearbeid i ${by.navn}?`, svar: `Vanlig vedlikehold som maling og reparasjon krever normalt ikke søknad. Endring av fasadens utseende eller materialer kan kreve byggemelding til ${by.navn} kommune.` },
    { sporsmal: `Når er beste tid for fasadearbeid i ${by.navn}?`, svar: `Sesongen fra april til oktober er best for fasadearbeid. Temperaturen bør være over 5 grader, og det bør være tørt under arbeidet.` },
  ];
