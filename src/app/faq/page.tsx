...
const FAQ_ITEMS = [
  ...
  { sporsmal: "Hvor ofte bør man male huset?", svar: "Trefasader bør males hvert 8 til 12 år avhengig av eksponering. Sørvendte og vestvendte vegger slites raskere." },
  ...
  { sporsmal: "Hvilken type kledning er best?", svar: "Det avhenger av preferanser og budsjett. Trekledning er rimeligst og mest tradisjonelt. Fibersement er vedlikeholdsfritt. Kompositt gir moderne uttrykk." },
  ...
  { sporsmal: "Hva er forskjellen på puss og maling?", svar: "Puss er et tykt lag som legges på mur og gir en ny overflate. Maling er en tynnere behandling som dekker eksisterende overflate." },
];
